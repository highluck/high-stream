...
public class KafkaDeserializerConfig extends AbstractConfig {
    ...
    public KafkaDeserializerConfig(Map<String, ?> settings) {
        super(KafkaDeserializerConfig.config(), settings);
